...
const struct CS_String logfilter_uri = CS_STRING("/freezer/logfilter");
...
{ CS_HTTP_METHOD_ANY, CS_ROUTE_TYPE_FILTER, NULL, logfilter, NULL },
{ CS_HTTP_METHOD_POST, CS_ROUTE_TYPE_EXACT, &api_logbody_uri, logBody, NULL },
{ CS_HTTP_METHOD_POST, CS_ROUTE_TYPE_PREFIX, &api_product_putimage_uri, uploadImage, "image" },
{ CS_HTTP_METHOD_POST, CS_ROUTE_TYPE_PREFIX, &api_product_putinfo_uri, uploadImage, "info" },
